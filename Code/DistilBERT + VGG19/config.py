...
class Config:
    def __init__(self):
        ...
        self.distilbert_model = 'racai/distilbert-base-romanian-cased'
        self.distilbert_config = DistilBertConfig.from_pretrained(self.distilbert_model)

        self.model_type = 'late_fusion'  # 'early_fusion' or 'late_fusion'
        self.num_classes = 5
        self.image_feature_size = 25088
        ...
        self.model_save_path = '/home/danyez87/Licenta/model_distilbertvgg19latelr1e-5dropout0.3epochs20.pt'