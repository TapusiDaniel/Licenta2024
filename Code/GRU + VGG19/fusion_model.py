...
class EarlyFusionModel(nn.Module):
    def __init__(self, num_classes, gru_config, image_feature_size, dropout_prob=0.5):
        ...
        self.vgg19_fc = nn.Linear(25088, gru_config.hidden_size * 2 if gru_config.bidirectional else gru_config.hidden_size)
    ...
    def forward(self, input_ids, lengths, attention_mask, image):
        ...
        fused_features = torch.cat((gru_pooled_output, vgg19_features), dim=1)
