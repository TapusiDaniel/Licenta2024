...
class EarlyFusionModel(nn.Module):
    def __init__(self, num_classes, distilbert_config, dropout_prob=0.5):
        ...
        self.resnet_fc = nn.Linear(1000, distilbert_config.hidden_size)
    ...
    def forward(self, input_ids, attention_mask, image):
        ...
        distilbert_pooled_output = distilbert_pooled_output.unsqueeze(1).expand(-1, resnet_features.size(1))
        
        fused_features = torch.cat((distilbert_pooled_output, resnet_features), dim=1)
